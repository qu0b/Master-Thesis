...
Blockchain technology was developed in the wake of the 2008 financial crisis. Today, it could help shape the future of a border less financial world. It eradicates the need for a trusted third party but makes everything public. Although transactions are pseudonymous future revelations of identity can be disastrous. It is the modern way of storing money under the bed. Well, not quite the blockchain has many usecases although most have yet to be realized; one thing is sure, it is not solely a currency revolution.
%TODO - below we will look at blablabla
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Smart Contracts / Chain code}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
